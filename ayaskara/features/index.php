...
<div class="container">
	...
	<div class="item">
		<img src="../../assets/image/ayaskara/feature1.png">
		<div class="text">
			<h2>"Head into battle<br>and get stronger."</h2>
			<p>A tower defense<br>real-time strategy game.</p>			
		</div>
		<div class="clearfix"></div>
	</div>
	<div class="item">
		<img src="../../assets/image/ayaskara/feature2.png">
		<div class="text">
			<h2>"Meet requirment to<br>unlock stronger classes."</h2>
			<p>Form a party suited<br>to your best play style.</p>			
		</div>
		<div class="clearfix"></div>
	</div>
	<div class="item">
		<img src="../../assets/image/ayaskara/feature3.png">
		<div class="text">
			<h2>"Brace yourself."</h2>
			<p>Defend your castle at all cost<br>againts strong bosses.</p>			
		</div>
		<div class="clearfix"></div>
	</div>
	<footer>
		<div class="text">
			<img src="../../assets/image/ayaskara/tictech-logo.png">
			&copy; 2019 Tictech Studio All Right Reserved
		</div>
	</footer>
</div>
